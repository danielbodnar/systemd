...
| `networks`, `endpoint_mode`, `hostname`, `dns`, `extra_hosts` | nothing | Lossy in this renderer: the service is in the host namespace. `systemd-networkd` and `systemd-machined` cover them. |
