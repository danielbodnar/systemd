...
import { loadCatalog } from "../../../docker-swarm-to-systemd/contract/catalog.ts";
...
import {
  ...
  selectConcepts,
  validateMap,
} from "../../../docker-swarm-to-systemd/skills/docker-to-systemd-planner/scripts/plan-map.ts";

const catalog = loadCatalog();
const map = loadMap();
const capture = resolve(import.meta.dir, "../../../../test/test-container-migration/capture");
const example = JSON.parse(
  readFileSync(resolve(import.meta.dir, "../../../docker-swarm-to-systemd/skills/docker-swarm-to-inventory/references/example-inventory.json"), "utf8"),
) as Inventory;
