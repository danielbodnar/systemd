...
import { addHost, nodeMatchesPlatform, nodeSatisfies, parseConstraint, placeService, render } from "../../../podman-container-to-quadlet/skills/podman-container-to-quadlet/scripts/render.ts";

const inv = JSON.parse(readFileSync(resolve(import.meta.dir, "../../../docker-swarm-to-systemd/skills/docker-swarm-to-inventory/references/example-inventory.json"), "utf8")) as Inventory;
