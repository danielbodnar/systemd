...
The harness test suite (`plugins/systemd-migration/harness`) normalizes and renders this capture; the integration test renders it on a booted image and starts what it rendered.
